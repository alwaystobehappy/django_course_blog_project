...
class BlogPostTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post1 = Post.objects.create(
            ...
            status=Post.STATUS_CHOICES[0][0],  # ----> mitavanim ingone benevisim ----> status = 'pub'
            author=cls.user,
        )
        cls.post2 = Post.objects.create(
            title='post2',
            text='lorem ipsum of post2',
            status=Post.STATUS_CHOICES[1][0],  # ----> mitavanim ingone benevisim ----> status = 'drf'
            author=cls.user,
        )

    def test_post_model_str(self):  # ---> def __str__(self): return self.title
        post = self.post1
    ...
    def test_post_update_view(self):
        ...
        self.assertEqual(Post.objects.last().text, 'how are you')
